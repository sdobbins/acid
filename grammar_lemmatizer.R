...
English_ing_keepers <- c("bring", "ceiling", "\\bcling", "darling", "\\bding", "\\bduring", "evening", "\\bfling", "\\bking", "lightning", "morning", "\\bpending", "\\bping", "\\bring", "sibling", "\\bsing", "(?:\\b|un|war)sling", "spring", "sterling", "\\bsting", "string", "swing", "(?:\\b|any|every|no|some)?thing", "(?:\\b|hind|fore)wing", "\\bwring", "\\bzing")
...
digested_word_dictionary <- function(words) {
  ...
  ence_to_ent <- endsWith(words, "ence") & !(endsWithAny(words, c("audience", "defence", "essence", "experience", "influence", "licence", "sentence")) | words %like% "\\b(?:[fhp]|sci|sp|th|wh)ence$") # endsWithAny(words, c("abhorrence", "absence", "accidence", "congruence", "diligence", "evidence", "immanence", "indolence", "inherence", "insistence", "nascence", "opulence", "patience", "permanence", "potence", "presence", "prudence", "quence", "residence", "reticence", "reverence", "salience", "tangence", "transcience", "valence", "violence"))
  ...
  if (isnt_empty(subset)) {
    ...
    eption_to_eive <- endsWith(subset, "eption") & !endsWithAny(subset, c("exception", "interception"))
